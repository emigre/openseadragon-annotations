...
const get_color = ifPluginIsActive(() => {
  return Store.getColor();
});

const set_color = ifPluginIsActive((strokeColor) => {
  Store.setColor(strokeColor);
});

const get_mode = ifPluginIsActive(() => {
  return Store.getMode();
});

const set_mode = ifPluginIsActive((canvas_mode) => {
  // Set mode 'DRAW' or 'MOVE'
  Store.setMode(canvas_mode);
});

const get_class = ifPluginIsActive(() => {
  return Store.getClass();
});

const set_class = ifPluginIsActive((className) => {
  Store.setClass(className);
});

export { get, set, clean, get_color, set_color, get_mode, set_mode, set_class, get_class };
